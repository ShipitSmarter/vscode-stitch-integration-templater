...
export class CreateIntegrationPanel {
  ...
  public static render(extensionUri: vscode.Uri) {
    if (CreateIntegrationPanel.currentPanel) {
      ...
      const panel = vscode.window.createWebviewPanel("create-integration", "Create Module Integration", vscode.ViewColumn.Two, {
        enableScripts: true
      });

      CreateIntegrationPanel.currentPanel = new CreateIntegrationPanel(panel, extensionUri);
    }
  }
